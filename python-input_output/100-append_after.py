...
specific string into a file. It adds the string after each
line that contains a specified search string. This functionality
...
def append_after(filename="", search_string="", new_string=""):
    ...
    a specific string. If the file does not exist, it creates an
    empty file first.
    ...
    try:
        ...
        """If the file does not exist, create an empty
        list of lines and also create the file"""
        lines = []
